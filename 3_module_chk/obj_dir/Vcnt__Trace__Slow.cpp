...
void Vcnt::traceInitThis__1(Vcnt__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->declBit(c+2,"rstn", false,-1);
        vcdp->declBus(c+3,"out", false,-1, 15,0);
        vcdp->declBit(c+4,"chk_3", false,-1);
        vcdp->declBit(c+1,"cnt clk", false,-1);
        vcdp->declBit(c+2,"cnt rstn", false,-1);
        vcdp->declBus(c+3,"cnt out", false,-1, 15,0);
        vcdp->declBit(c+4,"cnt chk_3", false,-1);
        vcdp->declBit(c+1,"cnt u0 clk", false,-1);
        vcdp->declBus(c+3,"cnt u0 chk_num", false,-1, 15,0);
        vcdp->declBit(c+4,"cnt u0 chk_out", false,-1);
    }
}
...
void Vcnt::traceFullThis__1(Vcnt__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBit(oldp+1,(vlTOPp->rstn));
        vcdp->fullSData(oldp+2,(vlTOPp->out),16);
        vcdp->fullBit(oldp+3,(vlTOPp->chk_3));
    }
}
